...
/**
 * In this example, a {@link ForkJoinPool} is used to implement
 * a merge sort for integer arrays.
 */
public class ForkJoinPoolExample {

	static class DivideTask extends RecursiveTask<int[]> {

		private static final long serialVersionUID = 7746114977928253234L;
		int[] arrayToDivide;
		...
		protected int[] compute() {
			/*
			 * We divide the array till it has only 1 element. We can also
			 * custom define this value to say some 5 elements. In which case
			 * the return would be Arrays.sort(arrayToDivide) instead.
			 */
		...
		private List<int[]> partitionArray() {
			...
			int[] partition2 = Arrays.copyOfRange(arrayToDivide,
					arrayToDivide.length / 2, arrayToDivide.length);
	...
	public static void main(String... args) {
		int[] array = { 1, 6, 2, 9, 5, 30, 22, 13, 3 };
